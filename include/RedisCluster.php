...
class RedisCluster
{
	 ...
	 * @return string || boolean	失败返回false，成功返回字符串
	 */
	...
	*/
	 ...
	 * 删除缓存
	 * 
	 * @param string || array $key	缓存KEY，支持单个键："key1"或多个键：array('key1', 'key2')
	 * @return int	删除的键的数量
	 */
